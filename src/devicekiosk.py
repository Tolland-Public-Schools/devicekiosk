...
from PyQt6.QtCore import QObject, pyqtSignal, pyqtSlot, Qt, QRunnable, QThread, QThreadPool, QProcessEnvironment, QByteArray
...
class UI(QObject):
    ...
    showDescriptionSignal = pyqtSignal()
    showDeviceSignal = pyqtSignal()
    showPrintSignal = pyqtSignal()
    showDropoffSignal = pyqtSignal()
    enableNextSignal = pyqtSignal()
    showLoanerSignal = pyqtSignal()
    showSubmitSignal = pyqtSignal()
    showSubmitPickupSignal = pyqtSignal()
    showReturnSignal = pyqtSignal()
    showPickupSignal = pyqtSignal()
    showErrorSignal = pyqtSignal(str)
    showErrorPageSignal = pyqtSignal()
    showFinishSignal = pyqtSignal()
    showEOYReturnSignal = pyqtSignal()
    showEOYStartSignal = pyqtSignal()
    showDailyLoanerDeviceScreenSignal = pyqtSignal()
    showDailyLoanerChargerScreenSignal = pyqtSignal()    
    showFinishDailyBorrowSignal = pyqtSignal()
    showFinishDailyReturnSignal = pyqtSignal()
    showOutstandingLoansSignal = pyqtSignal(str)
    showDailyHomeroomPageSignal = pyqtSignal()
    setHomeroomLabelSignal = pyqtSignal(str)
